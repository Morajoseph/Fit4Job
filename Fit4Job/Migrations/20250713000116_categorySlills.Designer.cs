...
namespace Fit4Job.Migrations
{
    ...
    [Migration("20250713000116_categorySlills")]
    partial class categorySlills
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Fit4Job.Models.Job", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex(new[] { "IsActive", "DeletedAt" }, "IX_Jobs_IsActive_DeletedAt");

                    b.ToTable("jobs");
                });

            modelBuilder.Entity("Fit4Job.Models.JobApplication", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("TaskSubmissionId")
                        .IsUnique()
                        .HasFilter("[TaskSubmissionId] IS NOT NULL");
            ...
            modelBuilder.Entity("Fit4Job.Models.CompanyExam", b =>
                {
                    ...
                    b.HasOne("Fit4Job.Models.Job", "Job")
                        .WithOne("Exam")
                        .HasForeignKey("Fit4Job.Models.CompanyExam", "JobId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Fit4Job.Models.CompanyTask", b =>
                {
                    ...
                    b.HasOne("Fit4Job.Models.Job", "Job")
                        .WithOne("Task")
                        .HasForeignKey("Fit4Job.Models.CompanyTask", "JobId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Fit4Job.Models.JobApplication", b =>
                {
                    b.HasOne("Fit4Job.Models.CompanyExamAttempt", "ExamAttempt")
                        .WithOne("JobApplication")
                        .HasForeignKey("Fit4Job.Models.JobApplication", "ExamAttemptId");
                    ...
                    b.HasOne("Fit4Job.Models.CompanyTaskSubmission", "TaskSubmission")
                        .WithOne("JobApplication")
                        .HasForeignKey("Fit4Job.Models.JobApplication", "TaskSubmissionId");
