...
{
    public class EditTrackQuestionDTO
    {
        ...
        public void UpdateTrackQuestion(TrackQuestion trackQuestion)
        {
            trackQuestion.TrackId = TrackId;
            trackQuestion.QuestionText = QuestionText;
            trackQuestion.QuestionLevel = QuestionLevel;
            trackQuestion.DifficultyLevel = DifficultyLevel;
            trackQuestion.QuestionType = QuestionType;
            trackQuestion.Points = Points;
            if(Explanation != null) trackQuestion.Explanation = Explanation; 
            if(CodeSnippet != null) trackQuestion.CodeSnippet = CodeSnippet;
            if(ExpectedOutput != null) trackQuestion.ExpectedOutput = ExpectedOutput;
