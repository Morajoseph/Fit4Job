...
namespace Fit4Job.Controllers
{
    ...
    public class AuthenticationController : ControllerBase
    {
        ...
        public AuthenticationController(IUnitOfWork unitOfWork, IConfiguration configuration, IEmailService emailService, UserManager<ApplicationUser> userManager)
        {
